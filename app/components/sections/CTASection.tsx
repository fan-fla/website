  ...
  return (
    <section id="contacto">
      ...
      <div className="flex w-full flex-col items-center gap-6 bg-[var(--accent-terracotta)] px-5 py-10 md:px-10 md:py-12 lg:px-20 lg:py-10">
        ...
        <p className="text-center font-inter text-[10px] text-white/60 md:text-[11px]">
          Resposta em menos de 2 horas • Pagamento por M-Pesa
        </p>
      </div>
    </section>
  );
